...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoibmdhbm5ndXllbiIsImEiOiJjazlteTk5anoybHJ4M2VudnF2eTlzamk2In0.ePaJqLsIdVfyBrpvarUfHw';
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = "http://127.0.0.1:3000/api/v1/users/update".concat(type === 'data' ? 'Me' : 'MyPassword');
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
var stripe = Stripe('pk_test_l3SXZbZhG4ONOZ0w9REO5Wy700CkR9RNIw');
